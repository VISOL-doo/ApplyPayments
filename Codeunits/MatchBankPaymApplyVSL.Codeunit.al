...
codeunit 71357863 "MatchBankPayApply_VSL"
{
    ...
    begin
        ...
        CustLedgerEntry.SetFilter("Customer No.", BankAccReconciliationLine."Account No.");
    ...
    begin
        ...
        VendorLedgerEntry.SetFilter("Vendor No.", BankAccReconciliationLine."Account No.");
