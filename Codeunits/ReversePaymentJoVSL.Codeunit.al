codeunit 71357865 "ReversePaymentJo_VSL"
{
    Access = Internal;
    ...
    begin
        ...
        case PaymentRecRelatedEntry."Entry Type" of
            ...
            PaymentRecRelatedEntry."Entry Type"::"Bank Account":
                if EmployeeLedgerEntry.Get(PaymentRecRelatedEntry."Entry No.") then begin
                    BankAccReconciliationLine."Account Type" := BankAccReconciliationLine."Account Type"::"Bank Account";
                    BankAccReconciliationLine."Account No." := BankAccountLedgerEntry."Bank Account No.";
                    BankAccReconciliationLine.Description := BankAccountLedgerEntry.Description;
                    BankAccReconciliationLine."Transaction Text" := BankAccountLedgerEntry.Description;
                    BankAccReconciliationLine."Transaction Date" := BankAccountLedgerEntry."Posting Date";
                    BankAccReconciliationLine.Validate("Statement Amount", -BankAccountLedgerEntry."Credit Amount");
                end;
        end;
    end;
